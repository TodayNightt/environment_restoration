...
import com.game.common.Terrain.Generation.NoiseMap;
...
import static com.game.common.Terrain.Chunk.CHUNK_SIZE;
...
public abstract class TerrainMap {
    ...
    public void init(String texture, Scene scene) {
        ...
        heightMap = NoiseMap.mapToInt(combineMap, -2, 1, Chunk.CHUNK_HEIGHT, 1);
        for (int i = 0; i < MAP_SIZE; i++) {
            for (int j = 0; j < MAP_SIZE; j++) {
                ...
                chunkList.add(createChunk(j, 0, i, newHeightMap, this));
            }
        }
    ...
    public abstract Chunk createChunk(int x, int y, int z, int[] heightMap, TerrainMap parent);
