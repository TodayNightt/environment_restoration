...
//
//
//    public static float[] getMeshFace(OldQuad faces, Vector3f position, Vector2f uvOffset) {
//        return switch (faces) {
//            case TOP -> new float[]{
...
//    }
//
//    public static void processQuad(FloatBuffer vertexDataBuffer, OldChunk.Cube self, OldChunk.Cube left, OldChunk.Cube right, OldChunk.Cube top,
//                                   OldChunk.Cube bottom, OldChunk.Cube back, OldChunk.Cube front) {
