...
//
//import com.game.lwjgl.Graphics.Mesh.OldTerrainMesh;
//import com.game.lwjgl.Terrain.OldTerrainMap;
//import org.joml.*;
//
...
//import static com.game.lwjgl.Graphics.OldQuad.*;
//
...
//    private final OldTerrainMap parentMap;
//    private OldTerrainMesh mesh;
//
//    public OldChunk(int xo, int yo, int zo, int[] givenMap, OldTerrainMap parentMap) {
...
//            index += 4;
//        }
//        mesh = new OldTerrainMesh(vertexDataBuffer.array(), indicesBuffer.array());
//    }
//
//    private Cube getNeighbour(OldQuad direction, int x, int y, int z) {
