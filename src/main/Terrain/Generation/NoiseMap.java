...
public class NoiseMap {
    ...
    public static void createColoredMap(int[]heightMap,int size) throws IOException {
        ...
        ImageIO.write(image,"png",new File("src/main/resources/map/map.png"));
