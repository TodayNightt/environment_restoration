...
public class Window {
    ...
    private final ImGuiGL31ES imGuiGl = new ImGuiGL31ES();
    private Scene scene;
...
//            scene.getPieceManager().addPiece(PieceCollection.getInstance().getPieceType().get(new Random().nextInt(PieceCollection.getInstance().getPieceType().size())));
//        }
