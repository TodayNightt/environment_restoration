...
public class OpenSimplexNoise {
	...
	public double eval(double x, double y, double z) {
		...
		// Floor to get simplectic lattice coordinates of rhombohedron (stretched cube)
		// super-cell origin.
		...
		if (inSum <= 1) { // We're inside the Tetrahedron (3-Simplex) at (0,0,0)
			...
			// The closest out of the two (0,0,1) and (1,1,0) will replace the furthest out
		...
		// Normalization constant tested using over 4 billion evaluations to bound range
		// within [-1,1].
		// This is a safe upper bound. Actual min/max values found over the course of
		// the 4 billion
	...
	// Also note that there's no reason this can't be a byte array other than that
	// this is Java.
